...
function isReplyToQuestion(context, identifier) {
    ...
    return Boolean(relevantEntity === null || relevantEntity === void 0 ? void 0 : relevantEntity.url.startsWith(expectedUrl));
}
...
function url(identifier, additionalState) {
    return encodeURI(BASE_URL + identifier + URL_SEPERATOR + (additionalState !== null && additionalState !== void 0 ? additionalState : ''));
}
